...
/* from olajep, submitted to ecyrbe/gnome-shell-extension-weather September 12, 2011 */

function init(metadata) {
    imports.gettext.bindtextdomain('gnome-shell-extension-weather', metadata.localedir);
}

let _weatherMenu;

function enable() {
    _weatherMenu = new WeatherMenuButton;
    Main.panel.addToStatusArea('weather-menu', _weatherMenu);
}

function disable() {
    _weatherMenu.destroy();
}
